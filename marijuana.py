...
#Load Keywords 
#Initial Set from Roget's Thesaurus and Urban Dictionary <-- This retrieved no tweets. Just using the word 'marijuana' for now
#What about doing both English and Spanish?
keyword_filename = 'synonyms_marijuana.txt'
delimiter = ','
...
record_filename = 'results_marijuana.txt'
